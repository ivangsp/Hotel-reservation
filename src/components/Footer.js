            ...
            <div className="container-fluid footer">
                <div className="row">
                    <div className="col-md-4 text-left">
                        <h3 className="pt-2 pl-3">About Equatorial Hotel</h3>
                        <p className="p-3">Equatorial hotel is world class hotel you a true definition of comfort, hospitality and
